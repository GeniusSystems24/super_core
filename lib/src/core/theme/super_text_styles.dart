  ...
  factory SuperTextTheme.fromTokens(
    ...
    if (isDesktop) {
      return SuperTextTheme._(
        displayLg:  d.copyWith(fontSize: 48, fontWeight: FontWeight.w700, height: 1.12),
        headlineSm: d.copyWith(fontSize: 22, fontWeight: FontWeight.w700, height: 1.25),
        titleMd:    d.copyWith(fontSize: 16, fontWeight: FontWeight.w600, height: 1.35),
        bodyLg:     b.copyWith(fontSize: 14, fontWeight: FontWeight.w400, height: 1.45),
        bodySm:     b.copyWith(fontSize: 13, fontWeight: FontWeight.w400, height: 1.45),
        labelMd:    b.copyWith(fontSize: 11, fontWeight: FontWeight.w600, height: 1.25, letterSpacing: 0.5),
        labelSm:    b.copyWith(fontSize:  9, fontWeight: FontWeight.w500, height: 1.25, letterSpacing: 0.4),
        mono: const TextStyle(fontFamily: 'JetBrainsMono', fontSize: 13, height: 1.35, fontWeight: FontWeight.w400, fontFeatures: [FontFeature.tabularFigures()]),
        eyebrow: b.copyWith(fontSize: 10, fontWeight: FontWeight.w700, height: 1.25, letterSpacing: 1.5),
        displayMediumStyle: d.copyWith(fontSize: 40, fontWeight: FontWeight.w700, height: 1.14),
        displaySmallStyle:  d.copyWith(fontSize: 32, fontWeight: FontWeight.w700, height: 1.18),
        headlineLargeStyle: d.copyWith(fontSize: 28, fontWeight: FontWeight.w700, height: 1.22),
        headlineMediumStyle:d.copyWith(fontSize: 24, fontWeight: FontWeight.w700, height: 1.25),
        titleLargeStyle:    d.copyWith(fontSize: 20, fontWeight: FontWeight.w600, height: 1.3),
        titleSmallStyle:    b.copyWith(fontSize: 14, fontWeight: FontWeight.w600, height: 1.35),
        captionStyle:       b.copyWith(fontSize: 11, fontWeight: FontWeight.w400, height: 1.35),
        buttonStyle:        b.copyWith(fontSize: 13, fontWeight: FontWeight.w600, height: 1.2),
      );
    }
    return SuperTextTheme._(
      displayLg:  d.copyWith(fontSize: 56, fontWeight: FontWeight.w700, height: 1.15),
      headlineSm: d.copyWith(fontSize: 24, fontWeight: FontWeight.w700, height: 1.3),
      titleMd:    d.copyWith(fontSize: 18, fontWeight: FontWeight.w600, height: 1.4),
      bodyLg:     b.copyWith(fontSize: 16, fontWeight: FontWeight.w400, height: 1.5),
      bodySm:     b.copyWith(fontSize: 14, fontWeight: FontWeight.w400, height: 1.5),
      labelMd:    b.copyWith(fontSize: 12, fontWeight: FontWeight.w600, height: 1.3, letterSpacing: 0.6),
      labelSm:    b.copyWith(fontSize: 10, fontWeight: FontWeight.w500, height: 1.3, letterSpacing: 0.5),
      mono: const TextStyle(fontFamily: 'JetBrainsMono', fontSize: 14, height: 1.35, fontWeight: FontWeight.w400, fontFeatures: [FontFeature.tabularFigures()]),
      eyebrow: b.copyWith(fontSize: 11, fontWeight: FontWeight.w700, height: 1.3, letterSpacing: 1.65),
      displayMediumStyle: d.copyWith(fontSize: 48, fontWeight: FontWeight.w700, height: 1.14),
      displaySmallStyle:  d.copyWith(fontSize: 38, fontWeight: FontWeight.w700, height: 1.18),
      headlineLargeStyle: d.copyWith(fontSize: 32, fontWeight: FontWeight.w700, height: 1.22),
      headlineMediumStyle:d.copyWith(fontSize: 26, fontWeight: FontWeight.w700, height: 1.25),
      titleLargeStyle:    d.copyWith(fontSize: 22, fontWeight: FontWeight.w600, height: 1.3, letterSpacing: -0.3),
      titleSmallStyle:    b.copyWith(fontSize: 16, fontWeight: FontWeight.w600, height: 1.35),
      captionStyle:       b.copyWith(fontSize: 12, fontWeight: FontWeight.w400, height: 1.35),
      buttonStyle:        b.copyWith(fontSize: 14, fontWeight: FontWeight.w600, height: 1.2),
    );
  }

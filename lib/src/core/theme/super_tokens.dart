...
abstract final class SuperTokens {
  ...
  // ── Field metrics (form-field kit) ───────────────────────────────────────────
  /// Comfortable field height (default density) used by the Super…Field inputs.
  static const double fieldComfortable = 42;

  /// Compact field height (dense density).
  static const double fieldCompact = 36;

  /// The +/- stepper button on numeric fields.
  static const double stepperSize = 24;

  /// In-field trailing affordance (clear / reveal / calendar / error badge).
  static const double trailingIcon = 26;

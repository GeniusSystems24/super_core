...
abstract final class SuperFormat {
  ...
  /// Formats [n] with grouped thousands and [decimals] fraction digits, with an
  /// optional [grouping] toggle. Returns '' for null/NaN — the null-safe variant
  /// the form-field kit uses: `number(1234.5, decimals: 2) -> "1,234.50"`.
